...
const DEFAULT_DEVICES: Device[] = [
  ...
  { id: "d4", deviceId: "MASH-D4-MAKATI-AC2526", model: "D4", location: "Makati", status: "Disconnected", assigned: false },
  { id: "d5", deviceId: "MASH-E5-PASIG-AC2527", model: "E5", location: "Pasig", status: "Connected", assigned: false },
  // archived mock device(s) for the archive view
  { id: "d6", deviceId: "MASH-F6-ARCHIVED-AC2528", model: "F6", location: "Makati", status: "Disconnected", assigned: false, archived: true },
  { id: "d7", deviceId: "MASH-G7-ARCHIVED-AC2529", model: "G7", location: "Pasig", status: "Disconnected", assigned: false, archived: true },
  { id: "d8", deviceId: "MASH-H8-ARCHIVED-AC2530", model: "H8", location: "Quezon City", status: "Disconnected", assigned: false, archived: true },
]
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-muted-foreground mt-1">{showArchived ? "Archived devices" : "List of registered devices"}</p>
          </div>
