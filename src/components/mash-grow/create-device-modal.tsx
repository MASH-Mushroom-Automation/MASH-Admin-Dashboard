...
export default function CreateDeviceModal({
  ...
  const locationYearPreview =
    (location ? location.charAt(0).toUpperCase() : "X") + String(currentYear);
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="font-mono py-2">
                    {editingId ? initialDevice?.deviceId : previewDeviceId}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="ml-auto">
                    <Button variant="outline" onClick={handleCheckPing}>
                      Check Ping
                    </Button>
                  </div>
                </div>
